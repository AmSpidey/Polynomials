...
/**
 * Wypisuje na standardowe wyj臷u203acie informacj腬u2122 o argumentach programu
 ...
 * @param op funkcja przyjmuj腬u2026ca dwa wielomiany jako argument i zwracaj腬u2026ca wielomian
 * (Domy臷u203alnie jedna z PolyAdd , PolySub, PolyMul)
 */
...
/**
 * Funkcja testuj腬u2026ca dodawanie, odejmowanie i mno偶enie liczb
 * za pomoc腬u2026 wielomian贸w
 */
bool SimpleArithmeticTest()
{
...
/**
 * Funkcja buduj腬u2026ca coraz d臷u201au偶sze wielomiany
 */
bool LongPolynomialTest()
{
    bool res = true;
...
/**
 * Test czy funkcje PolyAddMonos i MonoFromPoly przejmuj腬u2026 na w臷u201aasno臷u203a腬u2021
 * jednomiany i monomiany.
 * Uruchomione pod valgrindem nie powinno dawa腬u2021 wyciek贸w pami腬u2122ci
 */
void MemoryThiefTest()
{
...
/**
 * Sprawdza czy stopie臷u201e wielomianu poprawnie si腬u2122 zmienia
...
/**
 * Prosty test ewaluacji (PolyAt) wielomian贸w.
 * Testuje czy dobrze s腬u2026 dobrane typy danych.
 * Za臷u201aada, 偶e poly_coef_r jest typu long
 */
bool SimpleAtTest2()
{
    Poly p_one = PolyFromCoeff(1);
 ...
 *
 * Nast腬u2122pnie testowane jest PolyDeg i PolyDegBy
 * czy dzia臷u201aaja na prostym przypadku
 */
bool AtTest()
{
...
/**
 * Tworzenie wielomianu jednej zmiennej z listy wsp贸臷u201aczynnik贸w i wyk臷u201aadnik贸w
 * @param count rozmiar tablicy
 * @param val tablica wsp贸臷u201aczynnik贸w
 * @param exp tablica wyk臷u201aadnik贸w
 */
...
/**
 * Tworzenie wielomianu wielu zmiennych z listy wielomian贸w i wyk臷u201aadnik贸w
 * @param count rozmiar tablicy
 * @param val tablica wsp贸臷u201aczynnik贸w
 * @param exp tablica wyk臷u201aadnik贸w
 */
...
/**
 * Buduje wielomian o okre臷u203alonej gleboko臷u203aci. Pobiera d臷u201augo臷u203a腬u2021 kolejnych
 * wielomian贸w z tablicy exp_arr i wyk臷u201aadniki z tablicy exp_arr1
 * wsp贸臷u201aczynniki s腬u2026 z tablicy coef_arr1.
 * @param depth g臷u201a腬u2122boko臷u203a腬u2021  (ilo臷u203a腬u2021 zmiennych) wielomianu
 * @param exp_shift wka藕nik do zmiennej przechowywuj腬u2026cej pozycje w
 * tablicach exp_arr i exp_arr2 (z const_arr.h)
 * @param coef_shift wka藕nik do zmiennej przechowywuj腬u2026cej pozycje w
...
/**
 * Buduje wielomian o okre臷u203alonej gleboko臷u203aci. Pobiera d臷u201augo臷u203a腬u2021 kolejnych
 * wielomian贸w z tablicy exp_arr i wyk臷u201aadniki z tablicy exp_arr (argument)
 * wsp贸臷u201aczynniki s腬u2026 z tablicy coef_arr(argument).
 * @param depth g臷u201a腬u2122boko臷u203a腬u2021 (ilo臷u203a腬u2021 zmiennych) wielomianu
 * @param exp_shift wka藕nik do zmiennej przechowywuj腬u2026cej pozycje w
 * tablicy exp_arr
 * @param coef_shift coef_shift wka藕nik do zmiennej przechowywuj腬u2026cej pozycje w
 * tablicy coef_arr
 * @param coef_arr tablica wsp贸臷u201aczynnik贸w
 * @param exp_arr tablica wyk臷u201aadnik贸w i d臷u201augo臷u203aci
 * @return
 */
...
/**
 * Sprawdza czy PolyDegBy i PolyDeg przegl腬u2026daj腬u2026 wszystkie potrzebne
 * elementy struktury
 */
bool DegByTest()
{
...
/**
 * Sprawdza mno偶enie na wzorach skr贸conego mno偶enia
 */
bool MulTest()
{
    {
 ...
 * gdzie ka偶da zmienna wyst腬u2122puje w dok臷u201aadnie jednym jednomianie
 * @param coef_arr
 * @param exp_arr
 * @param rec
 */
...
/**
 * Testuje czy dodawanie d臷u201augich wielomian贸w jednej zmiennej dzia臷u201aa poprawnie
 * Testuje dzia臷u201aanie PolyNeg
 */
bool AddTest1()
{
...
/**
 * Testuje czy dodawanie d臷u201augich wielomian贸w wielu zmiennych dzia臷u201aa poprawnie
 * Testuje dzia臷u201aanie PolyNeg
 */
bool AddTest2()
{
...
/**
 * Testuje czy odejmowanie d臷u201augich wielomian贸w jednej zmiennej dzia臷u201aa poprawnie
 */
bool SubTest1()
{
    const poly_exp_t step = 10;
...
/**
 * Testuje czy odejmowanie d臷u201augich wielomian贸w wielu zmiennych dzia臷u201aa poprawnie
 */
bool SubTest2()
{
    bool good = true;
...
/**
 * Funkcja pomocnicza do tworzenie wynik贸w mno偶enia wielomianow 
 * @param size1 d臷u201augo臷u203a腬u2021 danych w arr_1
 * @param arr_1 tablica wspolczynnikow pierwszego wielomiannu
 * @param size2 d臷u201augo臷u203a腬u2021 danych w arr_2
...
/**
 * Test mno偶enia d臷u201augich wielomian贸w.
 * Sprawdza poprawno臷u203a腬u2021 i wydajno臷u203a腬u2021 implementacji
 */
bool MulTest2()
{
    bool good = true;
    ...
    // rozwi腬u2026zanie w trybe relase na studentsie wykonuje si腬u2122 w 1m44.373s (real) 
...
/**
 * Sprawdza poprawno臷u203a腬u2021 dzia臷u201aania funkcji PolyIsEq na d臷u201au偶szych przyk臷u201aadach
 * @return
 */
bool IsEqTest()
{
...
/**
 * Sprawdza czy jest u偶ywana implementacja wielomian贸w,
 * kt贸ra nie zajmuje du偶ej ilo臷u203aci pami腬u2122ci dla rzadkich wielomian贸w.
 * Test b腬u2122dzie uruchamiany z ma臷u201aym limitem pami腬u2122ci.
 */
bool RarePolynomialTest()
{
    bool result = true;
...
// Sekcja z testami tworzonymi r腬u2122cznie
...
/**
 * Pomocnicze makro do tworzenia wielomian贸w.
...
/**
 * Testuje czy Stopie臷u201e wielomianu jest poprawnie liczony rekurencyjnie.
 */
bool DegTest()
{
...
{
    bool res = true;
    // R贸偶ne przypadki wielomian/wsp贸臷u201aczynnik
    res &= TestAdd(
            C(1),
            C(2),
            C(3));
    ...
    res &= TestAdd(
            ...
            P(C(1), 1),
            P(C(1), 1));
    // Upraszczanie si腬u2122 wielomianu
    res &= TestAdd(
            P(C(1), 1),
            P(C(-1), 1),
            C(0));
    ...
    res &= TestAdd(
            ...
            P(C(-1), 1),
            C(2));
    // Dodawanie wsp贸臷u201aczynnika i upraszczanie
    res &= TestAdd(
            C(1),
            P(C(-1), 0, C(1), 1),
            P(C(1), 1));
    ...
    res &= TestAdd(
            ...
            P(P(C(-1), 0, C(1), 1), 0, C(2), 2),
            P(P(C(1), 1), 0, C(2), 2));
    // Dodawanie wielomian贸w wielu zmiennych
    res &= TestAdd(
    ...
    // Redukcja do wsp贸臷u201aczynnika
    res &= TestAdd(
